  ...
  <div id="menu_position">
    <ul id="menu">
        <li id="_MP104" ><a href="javascript:_MP(104,'<?php echo url('index/my') ;?>');">设置</a>
		  ...
		  <?php } ;?>
          <li id="_MP1080" ><a href="javascript:_MP(1080,'<?php echo url('keylink') ;?>');" >内链关键字</a></li>
          <li id="_MP1079" ><a href="javascript:_MP(1079,'<?php echo url('sitemap') ;?>');" >生成sitemap</a></li>
...
<div id="main">
  ...
  <div id="right">
    <div id="home">
    	<div id="shortcut">
    		<span title="网站首页" onclick="window.open('../')">网站首页</span>
			<span><a href="javascript:_MP(107,'<?php echo url('index/main'); ?>');" title="后台首页">后台首页</a></span>
    		<span><a href="javascript:_MP(107,'<?php echo url('index/cache'); ?>');" title="更新缓存">更新缓存</a></span>
    	</div>
