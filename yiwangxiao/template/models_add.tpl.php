	...
	<div class="content-menu">
		...
		<form action="" method="post">
                ...
                <tr>
                    <th>是否发送邮件：</th>
                    <td>
                        <input type="radio" <?php if (empty($data['setting']['form']['email'])) { ?>checked<?php } ?> value="0" name="data[setting][form][email]"  onclick='$(".email").hide();'> 否
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" <?php if ($data['setting']['form']['email']==1) { ?>checked<?php } ?> value="1" name="data[setting][form][email]"  onclick='$(".email").show();'> 是
                        <div class="onShow">可以用来接受一些订单信息</div>
                    </td>
                </tr>
                <tr  class="email"  <?php if (empty($data['setting']['form']['email'])) { ?>style="display: none"<?php } ?>>
                    <th>接受表单的邮箱：</th>
                    <td>
                        <input type="text" class="input-text" size="20" value="<?php echo $data['setting']['form']['smtpemailto']; ?>" name="data[setting][form][smtpemailto]"><div class="onShow">此处是收件人邮箱，请务必在系统配置中设置发件人邮箱信息</div>
                    </td>
                </tr>
                    ...
                    <tr  class="email"  <?php if (empty($data['setting']['form']['email'])) { ?>style="display: none"<?php } ?>>
                        <th>邮件标题：</th>
                        <td>
                            <input type="text" class="input-text" size="40" value="<?php echo $data['setting']['form']['mailsubject']; ?>" name="data[setting][form][mailsubject]">
                        </td>
                    </tr>
