...
<div class="content">
    ...
    <div class="a_fz" id="Div1">
        <div class="allcontent clearfix">
            <div class="a_fz_con_3_3">
                <?php $return = $this->_listdata("catid=$catid page=$page pagesize=15"); extract($return); if (is_array($return))  foreach ($return as $key=>$xiao) { ?>
                <dl class="h_300">
                    <dt><a target="_blank" rel="group" class="group" href="<?php echo image($xiao[thumb]); ?>" title="<?php echo $xiao['title']; ?>"><img src="<?php echo image($xiao[thumb]); ?>" alt="<?php echo $xiao['title']; ?>" title="<?php echo $xiao['title']; ?>" /></a></dt>
