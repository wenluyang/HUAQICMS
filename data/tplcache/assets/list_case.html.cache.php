...
<div class="content">
    <div class="right">
        ...
        <div class="right_main">
            ...
            </div>            <div class="news_con News_4 News_4_2">

            <?php $return = $this->_listdata("catid=$catid page=$page pagesize=10"); extract($return); if (is_array($return))  foreach ($return as $key=>$xiao) { ?>
            <dl class="dl_2s">
                <dt><a href="<?php echo $xiao['url']; ?>" title="<?php echo $xiao['title']; ?>" target="_blank"><img src="<?php echo image($xiao[thumb]); ?>" alt="<?php echo $xiao['title']; ?>" title="<?php echo $xiao['title']; ?>" /></a></dt>
                <dd>
                    <h4><a href="<?php echo $xiao['url']; ?>" title="<?php echo $xiao['title']; ?>" target="_blank"><?php echo $xiao['title']; ?></a></h4>
                    <p><?php echo strcut($xiao[description],150); ?>...</p>
                    <span class="fl em01">
<a href="http://wpa.qq.com/msgrd?v=3&uin=<?php $this->block(13);?>&site=qq&menu=yes" title="立即咨询" target="_blank">立即咨询</a>
</span>
                    <span class="fl em01" style="margin-left:10px;">
<a href="<?php echo $xiao['url']; ?>" title="查看详情" target="_blank">查看详情</a>
</span>
                </dd>
            </dl>
            <?php } ?>
