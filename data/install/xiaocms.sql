...
(1, 2, '幻灯图片1', 'http://demo.xiaocms.com/template/default/images/2.png'),
(2, 2, '幻灯图片2', 'http://demo.xiaocms.com/template/default/images/3.png'),
(3, 2, '幻灯图片3', 'http://demo.xiaocms.com/template/default/images/2.png'),
(4, 2, '网站LOGO', 'http://www.99v6.com/style/css/img/logo.png'),
(5, 1, '手机号码', '13888888888'),
(6, 1, '固定电话', '010-88888888'),
(7, 1, '传真号码', '010-66666666'),
(8, 1, '电子邮箱', 'Shenhui3344@qq.com'),
(9, 1, '办公地址', '陕西省西安市XX区XX路XX号'),
(10, 1, '版权信息', '版权所有 &copy; 晟辉网络www.99v6.com&nbsp;&nbsp;&nbsp;&nbsp;QQ：81348244'),
(11, 1, '客服QQ', '81348244');
...
(6, 4,'友情链接','diy_flink','list_flink.html','show_flink.html','','a:1:{s:4:"form";a:1:{s:4:"show";a:3:{i:0;s:8:"sitename";i:1;s:7:"siteurl";i:2;s:9:"showorder";}}}');
...
(7, 6, 'sitename','网站名称','1','','1','网站名称不能为空','input','a:2:{s:4:"size";s:3:"180";s:12:"defaultvalue";s:0:"";}',0,0),
(8, 6, 'siteurl','网站链接','1','请输入网站链接如：http://www.99v6.com','/^http:\\/\\//','请输入带http://的完整链接地址','input','a:2:{s:4:"size";s:3:"180";s:12:"defaultvalue";s:0:"";}','0','0'),
(9, 6, 'showorder','显示顺序','1','可根据显示序号来前台调用','/^[0-9-]+$/','请输入数字','input','a:2:{s:4:"size";s:3:"180";s:12:"defaultvalue";s:1:"0";}',0,0);

DROP TABLE IF EXISTS `xiao_diy_flink`;
CREATE TABLE `xiao_diy_flink` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `xiao_diy_flink` VALUES(1,'晟辉网络','http://www.99v6.com','0');